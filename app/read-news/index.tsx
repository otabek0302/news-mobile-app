...
const NewsRead = () => {
  ...
  const renderHeader = () => (
    <>
      ...
      <View style={{ padding: 16 }}>
        {newsData.urlToImage ? (
          <Image source={{ uri: newsData.urlToImage }} style={styles.image} resizeMode="cover" />
        ) : (
  ...
  return (
    <View style={styles.container}>
      <FlatList data={[]} renderItem={null} ListHeaderComponent={renderHeader} showsVerticalScrollIndicator={false} />
    </View>
  );
};
